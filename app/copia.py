...
origins = [
    "https://gestordecursos.pegui.edu.co",
    "https://gestordecursos.pegui.edu.co:8000",
    "https://gestordecursos.pegui.edu.co:8446"
]
...
def swagger_docs(authenticated: bool = Depends(auth)):
    return get_swagger_ui_html(openapi_url="/openapi.json", title="Swagger UI")

@app.get("/openapi.json")
def openapi_json(authenticated: bool = Depends(auth)):
    return get_openapi(title="Virtualmind API", version="1.0.0", routes=app.routes)
