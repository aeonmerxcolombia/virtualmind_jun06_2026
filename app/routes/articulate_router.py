...
class VirtualmindBrain:
    ...
    async def infer_specialized(self, module: str, system_instruction: str, user_data: Any, schema_class: Any):
        ...
        payload = {
            ...
            "systemInstruction": {"parts": [{"text": self._get_master_system_prompt(module)}]},
            "generationConfig": {
        ...
        try:
            ...
            return {"error": "Fallo en la Sincronización Neural", "details": str(e), "is_error_object": True}
...
async def generate_master_course(request: AIRequest):
    ...
    return await brain.infer_specialized("Master Course Architect", instruction, request.prompt, MasterCourseResponse)
...
async def copy_refine(request: AIRequest):
    ...
    return await brain.infer_specialized("Expert Refiner", instruction, request.contexto_actual, RefineResponse)
...
async def game_story(request: AIRequest):
    ...
    return await brain.infer_specialized("Story Arc Master", instruction, request.prompt, StorytellingResponse)
...
async def copy_hooks(request: AIRequest):
    ...
    return await brain.infer_specialized("Hook Engine", instruction, request.contexto_actual, HookResponse)
...
async def interact_quiz(request: AIRequest):
    ...
    return await brain.infer_specialized("Quiz Generator", instruction, request.contexto_actual, BlockSchema)
...
async def ui_bento(request: AIRequest):
    ...
    return await brain.infer_specialized("Bento Architect", instruction, request.contexto_actual, BlockSchema)
...
async def copy_feynman(request: AIRequest):
    ...
    return await brain.infer_specialized("Feynman Simplifier", instruction, request.contexto_actual, RefineResponse)
...
async def interactive_challenges(request: AIRequest):
    ...
    return await brain.infer_specialized("Mission Architect", instruction, request.contexto_actual, BlockSchema)
...
async def audit_pedagogic(request: AIRequest):
    ...
    return await brain.infer_specialized("PhD Auditor", instruction, request.contexto_actual, AuditResponse)
